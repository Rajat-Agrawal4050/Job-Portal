  ...
  <div class="container">
    <div class="row g-lg-4 gy-5">
        ...
        <div class="job-sidebar">
          <div class="job-widget style-1">    
            <div class="check-box-item">
              ...
              <div class="company-dt-sb">
                <div class="company-overview-area">
                  <div class="">
                    <img id="image_output"
                      alt="profile pic"
                      src="{{ empty($user->profile_pic) ? asset('assets/images/avatar-new.png') : asset('profile_pic/'.$user->profile_pic) }}"
                      height="100px"
                      width="100px"
                      style="border-radius: 50%"
                      class="rounded" onclick="document.getElementById('imgFile').click()" />

                    <input type="file" name="" data-target="image_output" onchange="previewImage(this)" id="imgFile" hidden>
                  </div>
                  <br />
                  <ul>
                    <li>
                      <!-- <span style="color: #00a7ac; font-weight: 600">Designation:</span> -->
                      {{$user->designation}}
                    </li>
                    <li>
                      <div class="sign-in-btn">
                        <a class="primry-btn-1 lg-btn" id="changeBtn" href="#">Change Picture</a>
                      </div>
          ...
          <div class="job-widget" style="margin-top: -55px">
            <div class="check-box-item">
              <!-- <h5 class="job-widget-title">Type of Employments</h5> -->

              <div class="dashboard-area company-dashboard">
                <div class="container">
                  <div class="row">
                      ...
                      <div class="dashboard-sidebar">
                        <div class="dashboard-menu">
                          <ul style="display: flex; flex-direction: column">
                            ...
                            <li>
                              <a class="active" href="/user/profile">
                                <svg
                                  width="18"
                                  height="16"
                                  viewBox="0 0 18 16"
                            ...
                            <li>
                              <a href="/logout">
                                <svg
                                  ...
                                  xmlns="http://www.w3.org/2000/svg">
                                  <path
                                    d="M12.5998 12.3312C12.6886 12.3312 12.7773 12.2972 12.845 12.2297L15.8352 9.24479C15.9708 9.10944 15.9708 8.89067 15.8352 8.75532C15.6996 8.61997 15.4805 8.61997 15.3449 8.75532L12.3546 11.7403C12.219 11.8756 12.219 12.0944 12.3546 12.2297C12.4222 12.2972 12.511 12.3312 12.5998 12.3312Z"></path>
                                  <path
                                    d="M4.90684 14.234C5.0986 14.234 5.25361 14.0789 5.25361 13.8878V4.11227C5.25361 3.92119 5.0986 3.76611 4.90684 3.76611C4.71507 3.76611 4.56006 3.92119 4.56006 4.11227V13.8878C4.56006 14.0789 4.71541 14.234 4.90684 14.234Z"></path>
                                  <path
                                    d="M15.3449 9.24487C15.4125 9.31237 15.5013 9.34629 15.5901 9.34629C15.6788 9.34629 15.7676 9.31237 15.8352 9.24487C15.9708 9.10952 15.9708 8.89075 15.8352 8.7554L12.845 5.77046C12.7094 5.63511 12.4902 5.63511 12.3546 5.77046C12.219 5.90581 12.219 6.12458 12.3546 6.25993L15.3449 9.24487Z"></path>
                                  <path
                                    d="M5.3521 14.6783C5.54387 14.6783 5.69888 14.5232 5.69888 14.3321C5.69888 14.1411 5.54387 13.986 5.3521 13.986C5.298 13.986 5.25361 13.942 5.25361 13.8877C5.25361 13.6966 5.0986 13.5415 4.90684 13.5415C4.71507 13.5415 4.56006 13.6966 4.56006 13.8877C4.55971 14.3238 4.91516 14.6783 5.3521 14.6783Z"></path>
                                  <path
                                    d="M4.90684 4.45857C5.0986 4.45857 5.25361 4.30349 5.25361 4.11241C5.25361 4.05841 5.298 4.0141 5.3521 4.0141C5.54387 4.0141 5.69887 3.85902 5.69887 3.66794C5.69887 3.47686 5.54387 3.32178 5.3521 3.32178C4.91516 3.32178 4.56006 3.67625 4.56006 4.11241C4.56006 4.30383 4.71541 4.45857 4.90684 4.45857Z"></path>
                                  <path
                                  ...
                                  <path
                                    d="M15.9368 9.00021C15.9368 8.80913 15.7817 8.65405 15.59 8.65405H7.13242C6.94065 8.65405 6.78564 8.80913 6.78564 9.00021C6.78564 9.19129 6.94065 9.34637 7.13242 9.34637H15.59C15.7817 9.34637 15.9368 9.19129 15.9368 9.00021Z"></path>
                                  <path
                                    d="M8.46794 13.9858H5.35215C5.16038 13.9858 5.00537 14.1409 5.00537 14.332C5.00537 14.5231 5.16038 14.6782 5.35215 14.6782H8.46794C8.65971 14.6782 8.81472 14.5231 8.81472 14.332C8.81472 14.1409 8.65971 13.9858 8.46794 13.9858Z"></path>
                                  <path
                                    d="M5.35215 4.01434H8.46794C8.65971 4.01434 8.81472 3.85926 8.81472 3.66818C8.81472 3.4771 8.65971 3.32202 8.46794 3.32202H5.35215C5.16038 3.32202 5.00537 3.4771 5.00537 3.66818C5.00537 3.85926 5.16038 4.01434 5.35215 4.01434Z"></path>
                                  <path
      ...
      <div class="col-lg-8 order-lg-2 order-1">
        <div class="job-listing-wrrap" style="margin-top: 0px">
          <div class="row g-4 mb-80"></div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="#" method="POST" id="Form1">
                    @csrf
                    <h5 style="font-family: var(--font-exo2);font-weight: 600;font-size: 1.25rem;color: var(--title-color1);" class="job-widget-title">My Profile</h5>
                    <div class="row mt-5">
                      <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-inner mb-25">
                          ...
                          <div class="input-area">
                            ...
                            <input type="text" name="designation" id="designation" value="{{ $user->designation }}" placeholder="Designation">
                          </div>
                          <p></p>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-inner mb-25">
                          <label for="jobplace">Mobile</label>
                          <div class="input-area">
                            <img src="assets/images/icon/company-2.svg" alt="">
                            <input type="text" id="mobile" name="mobile" value="{{ $user->mobile }}" placeholder="Mobile">
                          </div>
                          <p></p>
                        </div>
                      </div>
              ...
              <div class="card" style="margin-top: -80px;">
                ...
                <div class="card-body">
                  <form action="#" method="POST" id="Form2">
                    @csrf
                    <h5 style="font-family: var(--font-exo2);font-weight: 600;font-size: 1.25rem;color: var(--title-color1);" class="job-widget-title">Change Password</h5>
                    <div class="row mt-5">
                      <div class="col-md-12">
                        <div class="form-inner mb-25">
...
<script>
  function previewImage(file) {
    let img_file = file.files[0];
    let obj_url = URL.createObjectURL(img_file);
    let target_image = file.getAttribute('data-target');
    document.querySelector('#' + target_image).src = obj_url;
  }
  ...
  $('#changeBtn').click(function(e) {
    ...
    e.preventDefault();
    // alert('ok')
    let file = $('#imgFile').prop('files')[0];

    if (!file) {
      Swal.fire('Please Upload Image', '', 'error');
      return;
    }
    ...
    $.ajax({
      ...
      success: function(resp) {
        ...
        if (resp.status == false) {
          ...
          if (resp.errors.designation) {
            $('#designation').parent().siblings('p').addClass('text-danger').html(resp.errors.designation[0]);
          } else {
            $('#designation').parent().siblings('p').removeClass('text-danger').html('');
          }
          if (resp.errors.mobile) {
            $('#mobile').parent().siblings('p').addClass('text-danger').html(resp.errors.mobile[0]);
          } else {
            $('#mobile').parent().siblings('p').removeClass('text-danger').html('');
          }
        } else {
          $('#name').parent().siblings('p').removeClass('text-danger').html('');
          $('#email').parent().siblings('p').removeClass('text-danger').html('');
  ...
  $('#Form2').submit(function(e) {
    ...
    $.ajax({
      ...
      success: function(resp) {
        console.log(resp);
        if (resp.status == false) {
          if (resp.errors.old_password) {
            $('#old_password').parent().siblings('p').addClass('text-danger').html(resp.errors.old_password[0]);
          } else {
            $('#old_password').parent().siblings('p').removeClass('text-danger').html('');
          }
          if (resp.errors.new_password) {
            $('#new_password').parent().siblings('p').addClass('text-danger').html(resp.errors.new_password[0]);
          } else {
            $('#new_password').parent().siblings('p').removeClass('text-danger').html('');
          }

          if (resp.errors.cpassword) {
            $('#cpassword').parent().siblings('p').addClass('text-danger').html(resp.errors.cpassword[0]);
          } else {
