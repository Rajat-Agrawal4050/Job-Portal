              ...
              <tr>
                <td data-label="Job Title">
                  <div class="job-content">
                    <h5>
                      <a href="{{ route('job.detail',$job->id) }}">{{ $job->title }}</a>
                    </h5>
                    <p>
                      <img
                        src="assets/images/icon/calender2.svg"
                        alt /> {{ \Carbon\Carbon::parse($job->created_at)->format('d M, Y') }}
                    </p>
                ...
                <td data-label="Not Viewed">
                  <span class="total-number deep-pink">{{ $job->views }}</span>
                </td>
                <td data-label="Applications">
                  @if($job->status==1)
                  ...
                  <ul class="action-btn-group2">
                    ...
                    <li>
                      <a
                        ...
                        class="primry-btn-2 eg-btn sky--btn">
                        <svg
                          width="12"
                          height="12"
                          viewbox="0 0 12 12"
