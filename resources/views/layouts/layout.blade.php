<!DOCTYPE html>
<html lang="en">
<!-- /job-listing1.html  [XR&CO'2014],  08:44:26 GMT -->
        ...
        <div class="top-bar-right">
          <div class="language-select">
            ...
            <ul class="topbar-sublist">
              <li>
                <img
                  src="{{ asset('assets/images/icon/flag-germeny.svg') }}"
                  alt="image" /><span>Germeny</span>
              </li>
              <li>
                <img
                  src="{{ asset('assets/images/icon/flag-french.svg') }}"
                  alt="image" /><span>French</span>
              </li>
              <li>
                <img
                  src="{{ asset('assets/images/icon/flag-bangla.svg') }}"
        ...
        <div class="main-menu">
          <div
            ...
            <div class="mobile-logo-wrap">
              <a href="/"><img alt="image" src="{{ asset('assets/images/header1-logo.svg') }}" /></a>
            </div>
          ...
          <ul class="menu-list">
            ...
            <!-- <li class="menu-item-has-children">
              ...
              <ul class="sub-menu">
                ...
                <li><a href="blogs">Blog Standard</a></li>
                <li>
          ...
          <div class="for-mobile-menu d-lg-none d-block">
            ...
            <div class="post-job-btn mb-30">
              <a class="primry-btn-1 lg-btn" style="margin-bottom:12px;" href="/user/profile">
                <svg
                  width="15"
                  height="15"
                  viewbox="0 0 15 15"
                ...
                {{ Auth::user()->name }}</a>
              <a class="primry-btn-2 lg-btn" href="/job-post">
                <svg
                  width="15"
                  height="13"
                  viewbox="0 0 15 13"
          ...
          <ul>
            <li>
              <div class="btn-group dropdown">
                <div
                  class="notifications-area dropdown-toggle"
                  role="button"
                ...
                <div
                  class="notifacion-card dropdown-menu"
                  ...
                  <ul>
                    <li>
                      <div class="icon">
                        <img
                          src="{{ asset('assets/images/bg/company-logo/notifacion-1.png') }}"
                          alt />
                      </div>
                      <div class="content">
                        <h6>
                        ...
                        <span><img src="{{ asset('assets/images/icon/clock-1.svg') }}" alt /> 10
                          min ago</span>
                      </div>
                    </li>
                    <li>
                      <div class="icon">
                        <img
                          src="{{ asset('assets/images/bg/company-logo/notifacion-2.png') }}"
                          alt />
                      </div>
                      <div class="content">
                        <h6>
                    ...
                    <li>
                      <div class="icon">
                        <img
                          src="{{ asset('assets/images/bg/company-logo/notifacion-3.png') }}"
                          alt />
                      </div>
                      <div class="content">
                        <h6>
            ...
            <li class="d-md-flex d-none">
              <div class="sign-in-btn" style="display: flex;">
                @if(!Auth::check())
                <a class="primry-btn-1 lg-btn" href="/login">
                  <svg
                    width="15"
                  ...
                  Sign In</a>
                <a class="primry-btn-1 lg-btn" href="/register">Register</a>
                @else
                <a class="primry-btn-1 lg-btn" style="" href="/user/profile">
                  <svg
                    width="15"
                    height="15"
                    viewbox="0 0 15 15"
            ...
            <li class="d-md-flex d-none">
              <div class="post-job-btn">
                <a class="primry-btn-2 lg-btn" href="/job-post">Post Job
                  <svg
                    width="15"
                    height="13"
                    viewbox="0 0 15 13"
        ...
        <div
          ...
          <div class="footer-widget">
            ...
            <div class="menu-container">
              <ul>
                <li>
                  <a href="contact">Contact Us <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="#">Terms & Condition <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="#">Privacy & Policy <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="#">Candidate Listing <i class="bx bx-up-arrow-alt"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div
          ...
          <div class="footer-widget">
            ...
            <div class="menu-container">
              <ul>
                <li>
                  <a href="edit-profile.html">Create Resume <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="category.html">Browse Categories <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="bookmark.html">Save Jobs List <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="job-listing1.html">Browse Jobs <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="dashboard.html">Candidate Dashboard <i class="bx bx-up-arrow-alt"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div
          ...
          <div class="footer-widget">
            ...
            <div class="menu-container">
              <ul>
                <li>
                  <a href="job-post.html">Post A Job <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="#">Browse Candidates <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="pricing-plan.html">Job Packages <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="job-listing1.html">Jobs Featured <i class="bx bx-up-arrow-alt"></i></a>
                </li>
                <li>
                  <a href="company-dashboard.html">Employer Dashboard <i class="bx bx-up-arrow-alt"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row align-items-center">
          <div
            ...
            <div class="support">
              ...
              <div class="content">
                <h5>Support Line:</h5>
                <a href="tel:878346653460">878346653460</a>
              </div>
            </div>
          </div>
          <div
            ...
            <div class="footer-btm-menu">
              <ul>
                ...
                <li>
                  <a
                    href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3634979,17z/data=!3m1!4b1!4m5!3m4!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866">Our Sitemap</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row border-top align-items-center">
          <div
            ...
            <div class="copyright-area">
              <p>
                ©Copyright 2023 <a href="#">Job Portal</a> | Design By
                <a href="#">Job Portal</a>
              </p>
            </div>
          </div>
...
<!-- /job-listing1.html  [XR&CO'2014],  08:44:27 GMT -->
