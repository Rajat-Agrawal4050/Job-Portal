                      ...
                      <div class="dashboard-sidebar">
                        <div class="dashboard-menu">
                          <ul style="display: flex; flex-direction: column">
                            ...
                            <li>
                              <a class="active" href="/my-applications">
                                <svg
                                  width="18"
                                  height="18"
                                  viewBox="0 0 18 16"
      ...
      <div class="col-lg-8 order-lg-2 order-1">
        <div class="table-wrapper2" style="margin-top: 100px">
          <table class="eg-table table job-list-table mb-0">
            ...
            <tbody>
            @if($my_applications->isNotEmpty())
            @foreach($my_applications as $app)
              <tr>
                <td data-label="Job Title">
                  <div class="job-content">
                    <h5>
                      <a href="{{ route('job.detail',$app->job->id) }}">{{ $app->job->title }}</a>
                    </h5>
                    <p>
                      <img
                        src="assets/images/icon/calender2.svg"
                        alt /><span>Applied:</span> {{ \Carbon\Carbon::parse($app->applied_date)->format('d M, Y') }}
                    </p>
                  </div>
                </td>
                <td>
                ...
                <td data-label="Not Viewed">
                  <span class="total-number deep-pink">{{ $app->job->applications->count(); }}</span>
                </td>
                ...
                <td data-label="Action">
                  <ul class="action-btn-group2">
                    <li>
                      <a
                        href="javascript:void(0)" data-id="{{ $app->id }}" onclick="deleteApplication(this)"
...
<script>
  function deleteApplication(ele) {
