  ...
  <div class="job-listing-area mb-120">
    <div class="container">
      ...
      <div class="col-lg-4 order-lg-1 order-2">
        ...
        @endif -->
        @include('message')
            <form method="post" action="{{ route('job.post') }}" id="jobPostForm">
              @csrf
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <select id="cat" name="cat" class="select1">
                        ...
                        <option value="{{ $cat->id }}" {{ old('cat') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                        @endforeach
                        @endif
                      </select>
                    </div>
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <input
                        ...
                        id="vacancies"
                        name="vacancies"
                        placeholder="vacancy" value="{{ old('vacancies') }}" />
                    </div>
                    @error('vacancies')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                ...
                <div class="col-md-12">
                  <div class="form-inner">
                    ...
                    <textarea
                      name="summernote1"
                      id="summernote1"
                      placeholder="Something Write Yourself....">{{ old('summernote1') }}</textarea>
                  </div>
                  @error('summernote1')
                  <p class="text-danger">{{ $message }}</p>
                  @enderror
