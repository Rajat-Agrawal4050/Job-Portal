        ...
        <div class="job-sidebar">
          <div class="job-widget style-1">
            <div class="check-box-item">
              <h5 class="job-widget-title">{{Auth::user()->name}}</h5>
              ...
              <div class="company-dt-sb">
                <div class="company-overview-area">
                  <div class="">
                    <img id="image_output"
                      alt="profile pic"
                      src="{{ empty(Auth::user()->profile_pic) ? asset('assets/images/avatar-new.png') : asset('profile_pic/'.Auth::user()->profile_pic) }}"
                      height="100px"
                      width="100px"
          ...
          <div class="col-lg-8 order-lg-2 order-1">
            ...
            @include('message')
            <form method="post" action="{{ route('edit.job') }}" id="editForm">
              @csrf
              <div class="row">
                <div class="col-lg-12">
