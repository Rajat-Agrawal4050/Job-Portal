                      ...
                      <div class="dashboard-sidebar">
                        <div class="dashboard-menu">
                          <ul style="display: flex; flex-direction: column">
                            ...
                            <li>
                              <a class="active" href="/saved-jobs">
                                <svg
                                  width="18"
                                  height="16"
                                  viewBox="0 0 18 16"
              ...
              <tr>
                <td data-label="Job Title">
                  <div class="job-content">
                    <h5>
                      <a href="{{ route('job.detail',$job->job->id) }}">{{ $job->job->title }}</a>
                    </h5>
                    <p>
                      <img
                        src="assets/images/icon/calender2.svg"
                        alt /><span>Saved :</span> {{ \Carbon\Carbon::parse($job->created_at)->format('d M, Y') }}
                    </p>
                ...
                <td data-label="Action">
                  <ul class="action-btn-group2">
                    <li>
                      <a data-id="{{ $job->id }}" onclick="deleteJob(this)"
...
<script>
  function deleteJob(ele) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: "You want to delete Saved Job!",
      icon: 'warning',
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.trim() == '1') {
              Swal.fire({
                title: 'Deleted!',
                text: 'This Saved Job has been deleted.',
                icon: 'success',
                confirmButtonText: 'OK'

              })
              ele.closest('tr').remove(); // finds nearest parent element
            } else if (data.trim() == '-2') {
              Swal.fire('Saved Job Not Found', '', 'error');
            } else {
