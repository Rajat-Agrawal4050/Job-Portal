        ...
        <div class="col-lg-8 order-lg-2 order-1">
          <div class="job-listing-wrrap" style="margin-top: 0px">
           ...
           <div class="form-wrapper">
            ...
            @include('message')
            <form method="post" action="{{ route('admin.edit_job') }}" id="editForm">
              @csrf
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <input
                        ...
                        id="title"
                        name="title"
                        placeholder="Title" value="{{ old('title', $job->title) }}" />
                    </div>
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <select id="cat" name="cat" class="select1">
                        ...
                        <option value="{{ $cat->id }}" {{ old('cat', $job->category_id ?? '') == $cat->id ? 'selected' : '' }}>{{ $cat->name }}</option>
                        @endforeach
                        @endif
                      </select>
                    </div>
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <input
                        ...
                        id="vacancies"
                        name="vacancies"
                        placeholder="vacancy" value="{{ old('vacancies', $job->vacancy) }}" />
                    </div>
                    @error('vacancies')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                      ...
                      <div class="col-lg-12">
                        <div class="input-area mb-25" id="fixedPrice">
                          ...
                          <input
                            type="text"
                            name="salary"
                            placeholder="Salary" value="{{ old('salary', $job->salary) }}" />
                        </div>
                        @error('salary')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                  ...
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <select id="job_type" name="job_type" class="select1">
                        ...
                        <option value="{{ $type->id }}" {{ old('job_type', $job->job_type_id ?? '') == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                        @endforeach
                        @endif
                      </select>
                    </div>
                ...
                <div class="col-md-6">
                  <div class="form-inner mb-25">
                    ...
                    <div class="input-area">
                      ...
                      <select id="experience" name="experience" class="select1">
                        <option value="">Select Experience</option>
                        @for ($i = 1; $i <= 10; $i++)
                          <option value="{{ $i }}" {{ old('experience', $job->experience ?? '') == $i ? 'selected' : '' }}>
                          {{ $i }} Year
                          </option>
                          @endfor
                      </select>
                ...
                <div class="col-md-6">
                  <div class="form-inner select-jobtag mb-25">
                    ...
                    <div class="input-area">
                      <img src="{{ asset('assets/images/icon/search-2.svg') }}" alt />
                ...
                <div class="col-md-12">
                  <div class="form-inner">
                    ...
                    <textarea
                      name="summernote1"
                      id="summernote1"
                      placeholder="Something Write Yourself....">{{ old('summernote1', $job->description) }}</textarea>
                  </div>
                  @error('summernote1')
                  <p class="text-danger">{{ $message }}</p>
                  @enderror
