      ...
      <div class="col-lg-8 order-lg-2 order-1">
        <div class="job-listing-wrrap" style="margin-top: 0px">
          ...
          <div class="row" id="job-content">
            <div
              class="g-lg-6 g-md-6 gy-6 justify-content-center"
              style="display: flex; gap: 18%; margin-left: 25%">
              <div class="col-lg-3 col-sm-6" style="margin-left: 5%">
                <div class="counter-single">
                  ...
                  <div class="coundown">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <h4 style="color: #00a7ac" class="odometer">{{ AllJob::where('status',1)->count() }}</h4>
                      <span
                        style="
                              color: #00a7ac;
                              font-size: 22px;
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="counter-single">
                  ...
                  <div class="coundown">
                    <p>Total Jobs</p>
                    <div class="d-flex align-items-center gap-2">
                      <h4 style="color: #00a7ac" class="odometer">{{ AllJob::count() }}</h4>
                      <span
                        style="
                              color: #00a7ac;
                              font-size: 22px;
