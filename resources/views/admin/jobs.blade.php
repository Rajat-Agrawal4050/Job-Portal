                      ...
                      <div class="dashboard-sidebar">
                        <div class="dashboard-menu">
                          <ul style="display: flex; flex-direction: column">
                            ...
                            <li>
                              <a class="active" href="/admin/jobs">
                                <svg
                                  width="18"
                                  height="16"
                                  viewBox="0 0 18 16"
                            ...
                            <li>
                              <a class="" href="/admin/job_applications">
                                <svg
                                  width="18"
                                  height="16"
                                  viewBox="0 0 18 16"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td data-label="Applications">
                  <span class="total-number">{{ $job->applications->count() }}</span>
                </td>
