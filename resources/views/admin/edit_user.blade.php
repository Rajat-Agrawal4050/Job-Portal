              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="#" method="POST" id="Form1">
                    @csrf
                    <h5 style="font-family: var(--font-exo2);font-weight: 600;font-size: 1.25rem;color: var(--title-color1);" class="job-widget-title">Edit User</h5>
                    <div class="row mt-5">
                      <div class="col-md-12">
      ...
      success: function(resp) {
        ...
        if (resp.status == false) {
          ...
          $('#mobile').parent().siblings('p').removeClass('text-danger').html('');
           ...
           window.location.href = '{{ route("admin.user_list") }}';
        }
      },
